    ...
    if (_cities != null && _cities!.isNotEmpty) {
      _dataGridRows = _cities!.map<DataGridRow>((CityWithProvinceAndCountry cityWithProvinceAndCountry) {
        return DataGridRow(cells: <DataGridCell>[
          ...
          DataGridCell<double>(columnName: 'Latitud', value: cityWithProvinceAndCountry.city.latitude),
          DataGridCell<double>(columnName: 'Longitud', value: cityWithProvinceAndCountry.city.longitude),
