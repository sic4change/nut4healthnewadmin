...
class VisitDataGridSource extends DataGridSource {
    ...
    if (_visits != null && _visits!.isNotEmpty) {
      _dataGridRows = _visits!.map<DataGridRow>((VisitCombined visitCombined) {
        return DataGridRow(cells: <DataGridCell>[
          ...
          DataGridCell<bool>(columnName: 'Vacunación Ácido fólico y Hierro', value: visitCombined.visit.acidfolicAndFerroVaccinated),
  ...
  DataGridRowAdapter buildRow(DataGridRow row) {
    return DataGridRowAdapter(cells: <Widget>[
      ...
      _buildStandardContainer(row.getCells()[22].value),
      _buildBoolean(row.getCells()[23].value),
